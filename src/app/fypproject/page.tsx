    ...
    return (
        <div className="min-h-screen text-2xl sm:text-4xl w-11/12 sm:w-4/5 m-auto pt-8 sm:pt-16 text-center">
            ...
            <p>
                ...
                Cupidatat commodo consectetur ex enim. Tempor tempor ad dolor ex esse qui proident irure. Minim mollit anim minim non quis eu nostrud laborum. Occaecat consectetur proident non veniam do aliqua ullamco irure irure incididunt exercitation sit. Nisi non laboris duis est veniam elit. Adipisicing reprehenderit mollit do anim voluptate non consectetur tempor do esse ullamco ipsum.
            </p>
        </div>
    )
}