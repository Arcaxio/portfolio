...
import JsSVG from "@/components/icons/javascript";
      ...
      <div className="flex flex-col justify-around min-h-dvh w-4/5 py-8 mx-auto">
        ...
        >
          <div className="text-6xl">
            ...
            >
              <p>
                I strive to design & develop software that is of satisfactory quality.
              </p>
            </motion.div>
          </div>
        </motion.div>
        <div>
          ...
          >
            <Marquee speed={150} gradient gradientColor="oklch(var(--b3))" autoFill className="h-24">
              <HTMLSVG className="fill-current mx-2" width="96px" height="96px" />
              <CSSSVG className="fill-current mx-2" width="96px" height="96px" />
              <JsSVG className="fill-current mx-2" width="96px" height="96px" />
              <TypescriptSVG className="fill-current mx-2" width="96px" height="96px" />
              <ReactSVG className="fill-current mx-2" width="96px" height="96px" />
              <NextjsSVG className="fill-current mx-2" width="96px" height="96px" />
              <TailwindSVG className="fill-current mx-2" width="96px" height="96px" />
              <PostgreSQLSVG className="fill-current mx-2" width="96px" height="96px" />
              <NodejsSVG className="fill-current mx-2" width="96px" height="96px" />
              <GitSVG className="fill-current mx-2" width="96px" height="96px" />
              <KubernetesSVG className="fill-current mx-2" width="96px" height="96px" />
              <PHPSVG className="fill-current mx-2" width="96px" height="96px" />
            </Marquee>
          </motion.div>
        </div>
      </div>
