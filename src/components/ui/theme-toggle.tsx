...
export const ThemeToggle = ({
    ...
    return (
        ...
        //         <input type="checkbox" className="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2" onClick={() => theme === "dark" ? setTheme("light") : setTheme("dark")} id='theme-toggle-button'/>
        ...
        <>
            <label className="swap swap-rotate" >
                ...
                <input type="checkbox" onClick={() => theme === "dark" ? setTheme("light") : setTheme("dark")} id='theme-toggle' />

                {
                    isClient ?
                        <>
                            {/* sun icon */}
                            <svg
                                className={`h-8 w-8 fill-current swap-on`}
                            ...
                            {/* moon icon */}
                            <svg
                                className={`h-8 w-8 fill-current swap-off`}
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24">
                                <path
